...
def RadNet_resnet3d(input_shape=(48,192,192)):
    ...
    out_stage = layers.Dense(13,activation="softmax",name="out_stage")
    ...
    NET = ResNet3D(input_shape=input_shape,output_layers=[out_seq,out_view,out_ctrs,out_body,out_stage])
    return NET.GetModel()